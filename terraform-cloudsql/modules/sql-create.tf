...
resource "google_sql_database_instance" "default" {
  ...
  name                = "${var.fl_app_env}-${var.fl_app_name}-${var.fl_app_carid}-${var.name}"
  ...
  settings {
    ...
    user_labels = merge({
      "fl_account_type" = var.fl_account_type
      "fl_app_carid" = var.fl_app_carid
      "fl_app_env" = var.fl_app_env
      "fl_app_name" = var.fl_app_name
      "fl_app_supportgroup" = var.fl_app_supportgroup
      "fl_app_tier" = var.fl_app_tier
      "fl_data_classification" = var.fl_data_classification
      "fl_data_sensitivity" = var.fl_data_sensitivity
      "fl_ops_supportgroup" = var.fl_ops_supportgroup
      "fl_provisioner_carid" = var.fl_provisioner_carid
      "fl_provisioner_repo" = var.fl_provisioner_repo
      "fl_provisioner_workspace" = var.fl_provisioner_workspace
    }, var.user_labels)
